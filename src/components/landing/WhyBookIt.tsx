      ...
      <div className="mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div>
          ...
          <p className="mt-6 max-w-lg leading-7 text-slate-600">
            BookIt replaces scattered DMs, spreadsheets and
            manual calendars with one simple booking experience
            for mentors and fellows.
          </p>
          ...
          <div className="mt-8 rounded-2xl bg-primary-600 p-8 text-white">
            ...
            <p className="mt-3 text-sm leading-6 text-primary-100">
              Discover resources, check availability, book your
              session and manage everything from your dashboard.
            </p>
